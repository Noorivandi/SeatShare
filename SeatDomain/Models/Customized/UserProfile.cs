...
namespace SeatDomain.Models
{
    public partial class UserProfile
    {
        ...
        public bool CanSendEmailConfirmCode
        {
            get
            {
                return !EmailConfirmed && !EmailExceedWaitTimeLimit && !EmailExceedSendCountLimit;
            }
        }
        ...
        public bool CanSendPhoneNumberConfirmCode
        {
            get
            {
                return !PhoneNumberConfirmed && !PhoneExceedWaitTimeLimit && !PhoneExceedSendCountLimit;
            }
        }
